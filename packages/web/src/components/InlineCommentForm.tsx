    ...
    <form onSubmit={handleSubmit} className="bg-gray-800 border border-gray-600 rounded-md p-3 mx-2 my-1">
      ...
      <div className="flex gap-2 mt-2 justify-end">
        ...
        <button
          type="submit"
          disabled={!body.trim()}
          className="px-3 py-1 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:text-gray-500 rounded transition-colors"
        >
          {submitLabel}
        </button>
      </div>
